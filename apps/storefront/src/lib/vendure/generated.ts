...
export type ProductOptionCustomFields = {
  ...
  swatch?: Maybe<Scalars['String']['output']>;
};
...
export type ActiveOrderSummaryQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', id: string, code: string, totalQuantity: number, totalWithTax: number, currencyCode: CurrencyCode } | null };
...
export type EligibleShippingMethodsQuery = { __typename?: 'Query', eligibleShippingMethods: Array<{ __typename?: 'ShippingMethodQuote', id: string, code: string, name: string, description: string, price: number, priceWithTax: number }> };
...
export type EligiblePaymentMethodsQuery = { __typename?: 'Query', eligiblePaymentMethods: Array<{ __typename?: 'PaymentMethodQuote', id: string, code: string, name: string, description: string, isEligible: boolean, eligibilityMessage?: string | null }> };
...
export type PlpCollectionQuery = { __typename?: 'Query', collection?: { __typename?: 'Collection', id: string, name: string, slug: string, description: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> } | null };

export type PlpSearchQueryVariables = Exact<{
  input: SearchInput;
}>;


export type PlpSearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<{ __typename?: 'SearchResult', productId: string, productName: string, slug: string, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', preview: string } | null, priceWithTax:
...
export const DeleteCustomerAddressDocument = gql`
  ...
  deleteCustomerAddress(id: $id) {
    ...
    `;
export const FacetValueCountDocument = gql`
    query FacetValueCount($facetValueId: ID!) {
  search(
    input: {facetValueFilters: [{and: $facetValueId}], groupByProduct: true, take: 1}
  ) {
    totalItems
  }
}
...
export const PdpProductDocument = gql`
  ...
  product(slug: $slug) {
    ...
    `;
export const PlpCollectionDocument = gql`
    query PlpCollection($slug: String!) {
  collection(slug: $slug) {
    ...
    `;
export const PlpSearchDocument = gql`
    query PlpSearch($input: SearchInput!) {
  search(input: $input) {
    totalItems
    items {
      productId
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ActiveOrderSummary(variables?: ActiveOrderSummaryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ActiveOrderSummaryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ActiveOrderSummaryQuery>({ document: ActiveOrderSummaryDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ActiveOrderSummary', 'query', variables);
    },
    ActiveOrderFull(variables?: ActiveOrderFullQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ActiveOrderFullQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ActiveOrderFullQuery>({ document: ActiveOrderFullDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ActiveOrderFull', 'query', variables);
    },
    AddItemToOrder(variables: AddItemToOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AddItemToOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddItemToOrderMutation>({ document: AddItemToOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'AddItemToOrder', 'mutation', variables);
    },
    AdjustOrderLine(variables: AdjustOrderLineMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AdjustOrderLineMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AdjustOrderLineMutation>({ document: AdjustOrderLineDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'AdjustOrderLine', 'mutation', variables);
    },
    ...
    SetCustomerForOrder(variables: SetCustomerForOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SetCustomerForOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetCustomerForOrderMutation>({ document: SetCustomerForOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SetCustomerForOrder', 'mutation', variables);
    },
    EligibleShippingMethods(variables?: EligibleShippingMethodsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<EligibleShippingMethodsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<EligibleShippingMethodsQuery>({ document: EligibleShippingMethodsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'EligibleShippingMethods', 'query', variables);
    },
    SetOrderShippingMethod(variables: SetOrderShippingMethodMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SetOrderShippingMethodMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SetOrderShippingMethodMutation>({ document: SetOrderShippingMethodDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SetOrderShippingMethod', 'mutation', variables);
    },
    TransitionOrderToState(variables: TransitionOrderToStateMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<TransitionOrderToStateMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<TransitionOrderToStateMutation>({ document: TransitionOrderToStateDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'TransitionOrderToState', 'mutation', variables);
    },
    EligiblePaymentMethods(variables?: EligiblePaymentMethodsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<EligiblePaymentMethodsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<EligiblePaymentMethodsQuery>({ document: EligiblePaymentMethodsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'EligiblePaymentMethods', 'query', variables);
    },
    AddPaymentToOrder(variables: AddPaymentToOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AddPaymentToOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AddPaymentToOrderMutation>({ document: AddPaymentToOrderDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'AddPaymentToOrder', 'mutation', variables);
    },
    CreateStripePaymentIntent(variables?: CreateStripePaymentIntentMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateStripePaymentIntentMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateStripePaymentIntentMutation>({ document: CreateStripePaymentIntentDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateStripePaymentIntent', 'mutation', variables);
    },
    ...
    PlpCollection(variables: PlpCollectionQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PlpCollectionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PlpCollectionQuery>({ document: PlpCollectionDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'PlpCollection', 'query', variables);
    },
