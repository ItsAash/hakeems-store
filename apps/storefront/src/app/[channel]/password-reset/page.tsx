...
export const metadata = { ...NOINDEX_METADATA, title: 'Reset Password' };
    ...
    <main className={`flex-1 py-section-sm ${CONTAINER}`}>
      <div className="mx-auto flex max-w-sm flex-col gap-8">
        ...
        {token ? (
          ...
          <p className="text-sm text-danger">This reset link is missing its token. Please use the link from your email.</p>
        )}
      </div>
    </main>
  );
